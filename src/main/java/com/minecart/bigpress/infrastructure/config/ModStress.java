...
public class ModStress extends ConfigBase {
    ...
    private static void assertFromBigPress(BlockBuilder<?, ?> builder) {
        if (!builder.getOwner().getModid().equals(BigPress.MODID)) {
            throw new IllegalStateException("If you really want to use my mod's config class, then contact me and I will delete this line");
        }
    }
